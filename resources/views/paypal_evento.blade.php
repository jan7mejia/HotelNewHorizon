            ...
            <div class="col-md-6 col-lg-4">
                ...
                <div class="mb-4 text-start">
                    <div class="d-flex justify-content-between mb-2">
                        <span class="text-light small fw-bold">Paso 2 de 2: Pago de Evento</span>
                ...
                <div class="card shadow-lg border-0 rounded-4">
                    <div class="card-body p-5">
                        ...
                        <a href="{{ route('eventos') }}" class="btn btn-link mt-3 text-muted text-decoration-none small">
    ...
    paypal.Buttons({
        ...
        createOrder: function(data, actions) {
            return actions.order.create({
                purchase_units: [{
                    description: "Reserva de Evento #{{ $reserva->id_reserva_evento }}",
        ...
        onApprove: function(data, actions) {
            return actions.order.capture().then(function(details) {
                document.querySelector('#paypal-button-container').innerHTML = 
                    '<div class="py-3 text-center"><div class="spinner-border text-primary"></div><p class="mt-2 fw-bold">¡Pago aceptado! Procesando evento...</p></div>';
                window.location.href = "{{ url('eventos/confirmar/'.$reserva->id_reserva_evento) }}";
            });
        }
