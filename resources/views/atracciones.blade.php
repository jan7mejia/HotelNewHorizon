...
<style>
/* ===== BANNER PRINCIPAL (COPIA EXACTA DE AREAS COMUNES) ===== */
.hero-banner {
    position: relative;
    width: 100%;
    min-height: 500px; 
    /* Imagen específica de atracciones con el mismo filtro oscuro */
    background: linear-gradient(rgba(0, 0, 0, 0.6), rgba(0, 0, 0, 0.6)), 
                url('{{ asset('img/bannerAt.jpg') }}') center/cover no-repeat;
    display: flex;
    align-items: center;
...
<div style="background-color: #000; min-height: 100vh;">
    ...
    <section class="hero-banner">
        <div class="hero-content">
            <h1>ATRACCIONES</h1>
            <p>Descubre lo mejor de nuestro entorno</p>
        </div>
    </section>

    {{-- SECCIÓN DE LISTADO --}}
    <section id="atracciones" class="py-5">
        <div class="container">
            
            <h2 class="text-center section-title">Lugares de Interés</h2>
                    ...
                    <div class="col-md-6 col-lg-4">
                        <div class="pro-card d-flex flex-column text-light">
                            ...
                            <div class="img-container-fix">
                                <img src="{{ asset('img/'.$attr->imagen) }}" alt="{{ $attr->nombre }}">
                            </div>
                            
                            <div class="card-body d-flex flex-column">
                                <h5>{{ $attr->nombre }}</h5>
                                <p>{{ $attr->descripcion }}</p>
                            </div>
...
<script>
    document.addEventListener("DOMContentLoaded", function() {
        ...
        // Caso alternativo si el main no tiene la clase py-4
